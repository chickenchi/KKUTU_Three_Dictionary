...
OR Word.word LIKE '%{back_initial[0]}'"""
    ...
    def neutral_attack(self, front_initial1, front_initial2, options, subjectSet):
        include_block = """
'학', '햄', '험', '혀', '혁', '승', '혐', '확', '획', '효', '훙', '훤', '흑', '힌', '팽', '핀', '핍', '핑', '탱', '턱', '텍', '톤', '틸', '캉', '캠', '켈', '쾌', '쿤', '쿵', '킬', '킴', '찹', '첩', '촉', '촐', '축', '췌', '잘', '젠', '족', '죄', '죽', '줌', '즉', '짚', '짝', '짤', '짬', '쫄', '쭉', '쭌', '찝', '업', '엿', '욜', '윤', '율', '융', '을', '잇', '샅', '샨', '샬', '섭', '셋', '숙', '슐', '십', '싹', '썩', '쎄', '쑥', '쓱', '씩', '밖', '법', '볏', '볕', '봇', '붙', '뼈', '뽕', '맛', '맷', '멤', '멱', '몬', '못', '뫼', '묘', '뮤', '랑', '랫', '렌', '렙', '렷', '롬', '룔', '륜', '률', '륭', '름', '릿', '닻', '댓', '댕', '덕', '덥', '델', '둑', '득', '듬', '딩', '떠', '또', '뜰', '뜸', '뜻', '낯', '넌', '넥', '넨', '녓', '뇰', '뉘', '늉', '늠', '닛', '겸', '곽', '굉', '궐', '궤', '균', '긍', '깐', '깝', '꺽', '꼼', '꿩'
"""
